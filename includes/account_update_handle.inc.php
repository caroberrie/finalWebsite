...
if(count($errors_array)==0){
	...
	$update_beauty_customers = "UPDATE beauty_customers 
		SET 
		...
		address_2 = '$address_2',
		city = '$city',
		beauty_states_id = '$beauty_states_id',
		zip = '$zip',
		date_created = '$date_created'
		WHERE beauty_customers_id = $beauty_customers_id";
	$exec_update_beauty_customers = @mysqli_query($link, $update_beauty_customers);
