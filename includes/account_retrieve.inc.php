<?php
$update_account_info = "SELECT first_name, last_name, email, phone, address_1, address_2, city, beauty_states_id, zip, date(date_created) as date_created
	FROM beauty_customers WHERE beauty_customers_id = $beauty_customers_id";
