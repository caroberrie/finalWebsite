...
$select_producst = "SELECT category, description, size, price, stock_quantity, date_added, photo
	FROM beautys
...
if(!$exec_select_producst){
	...
	echo "<tr><td colspan='6'>Number of Products:</td><td>".mysqli_num_rows($exec_select_producst)."</td></tr></table>";
